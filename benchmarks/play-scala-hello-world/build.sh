...
JAR="$DIR/target/scala-2.13/play-scala-hello-world-assembly-$VERSION.jar"
NIB="$DIR/target/play-scala-hello-world-$VERSION.nib"
...
"$DIR/sbtx" GraalVMNativeImage/packageBin
