...
VERSION=1.0.6
JAR="$DIR/target/quarkus-hello-world-$VERSION-runner.jar"
NIB="$DIR/target/quarkus-hello-world-$VERSION.nib"
...
# in this case that is 'quarkus-hello-world-$VERSION-runner'
IMAGE_NAME="quarkus-hello-world-$VERSION-runner"
